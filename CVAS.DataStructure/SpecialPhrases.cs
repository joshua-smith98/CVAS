...
namespace CVAS.DataStructure
{
    ...
    public partial class Library
    {
        ...
        public static readonly Phrase[] DEFAULT_PHRASES =
        {
            ...
            new Phrase(Phrase.SPECIAL_PHRASES["VERTICAL_LINE"].ToString(), new Silence(0)), // '|' - delay of 0ms
            new Phrase(Phrase.SPECIAL_PHRASES["COMMA"].ToString(), new Silence(100)), // ','  - delay of 100ms
            new Phrase(Phrase.SPECIAL_PHRASES["PERIOD"].ToString(), new Silence(250)) // '.' - delay of 250ms
        };
    }
}
